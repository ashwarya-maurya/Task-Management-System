...
const CompleteTask = ({data}) => {
  return (
    <div className='p-5 h-80 w-80 bg-lime-500 rounded-2xl shrink-0 flex flex-col'>
            ...
            <div className='mt-5 w-full h-10'>
                <h3 className='bg-green-700 text-center text-sm font-medium m-1 px-2 py-1 rounded'>Completed</h3>
            </div>
        </div>
  )
}
