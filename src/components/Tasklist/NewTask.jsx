...
const NewTask = ({data}) => {
  return (
        <div className='flex min-h-80 w-[min(20rem,calc(100vw-2rem))] shrink-0 snap-start flex-col rounded-2xl bg-cyan-500 p-4 sm:p-5'>
            ...
            <div className='mt-5 w-full'>
                <button className='min-h-10 w-full rounded bg-blue-600 px-2 py-1 text-sm font-medium hover:bg-blue-700 cursor-pointer'>Accept Task</button>
            </div>
        </div>
  )
}
